...
public class SpuController {
    ...
    public Result audit(@RequestBody Map<String, String> map){
        spuService.audit(map.get("id"), map.get("status"), map.get("message"), map.get("auditId"), map.get("operateLogId"));
        return new Result();
    }
