...
public class RoleController {
    ...
    public Result updateRoleResource(@RequestBody RoleResourceCombination roleResourceCombination){

        roleService.updateRoleResource(roleResourceCombination);
    ...
    public List<Integer> findRoleResource(Integer roleId){
        return roleService.findRoleResource(roleId);
    }
